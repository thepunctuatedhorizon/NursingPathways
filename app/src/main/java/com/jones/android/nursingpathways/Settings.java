...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setBackground(getResources().getDrawable(R.drawable.bttn_green));
        button2.setTextColor(getResources().getColor(R.color.pathBlack));
        ...
        button3.setBackground(getResources().getDrawable(R.drawable.bttn_green));
        button3.setTextColor(getResources().getColor(R.color.pathBlack));
